...
// 	 * @return {string}
// 	 */
// 	MyCryptoJS.prototype.encryptAES = function(word) {
...
// 	 * @return {string}
// 	 */
// 	MyCryptoJS.prototype.decryptAES = function(word) {
// 		var key = CryptoJS.enc.Utf8.parse("Easyman-easyman3");
// 		var iv = CryptoJS.enc.Utf8.parse('Easyman-easyman3');
// 		var bytes = CryptoJS.AES.decrypt(word, key, {iv: iv, mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7});
